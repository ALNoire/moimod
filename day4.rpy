label label_day_5:
    ...
    "Славя оставила мне пару булок, завернутых в плотный бумажный пакет."
    stop ambience fadeout 1
    play ambience ambience_ext_road_day fadein 1
...
label day_4_1:
    ...
    hide black 
    with dissolve
    "Нам было так хорошо рядом, что мы не заметили как на небе сгустились тучи и начался сильнейший ливень."
...
label day_4_2:
    ...
    ya "Нет, уже не могу."
    mz "Почему?"
    ya "Без тебя не вижу ни в чем смысла. Так что вставай и пошли."
