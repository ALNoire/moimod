...
label day_3_1:
    ...
    if prosmotr == True:
        ...
        "— Товарищ генерал, капитан Смирнов на связи, сэр."
...
label day_3_2:
    ...
    mz "Стараюсь не опазывать, а то подумают чего, расспросы начнутся."
...
label night_3_1:
    ...
    if priz == True:
        ...
        ya "Пожалуйста! Если я не попрощу прощения, то сам не усну сегодня."
